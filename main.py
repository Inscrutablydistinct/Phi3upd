...
Note:
- All metadata attributes may or may not be present in the given query.
- The main query should be the input user query. Only use double quotes in the answer.
...
- Give the output at all costs, always include the main query and the non empty/Not specified identified metadata attributes.
